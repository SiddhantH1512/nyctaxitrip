...
# Example usage
local_model_path = 'models/trained_model.joblib'
s3_bucket_name = 'nyc-taxi-project-data'
s3_file_path = 'models/trained_model.joblib' 

upload_to_s3(local_model_path, s3_bucket_name, s3_file_path)
shutil.copy(local_model_path, 'trained_model.joblib')